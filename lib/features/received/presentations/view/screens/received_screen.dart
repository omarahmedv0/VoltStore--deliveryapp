...
import '../../view_model/cubit/received_cubit.dart';
...
class ReceivedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ReceivedCubit, ReceivedState>(
      builder: (context, state) {
        var cubit = ReceivedCubit.get(context);
        return Scaffold(
          body: ListView(
            ...
            children: [
              ...
              HandlingStateView(
                  ...
                  conditionLoading: state is GetApproveDataLoading || state is GetAcceptDataLoading || state is GetReceivedDataLoading,
